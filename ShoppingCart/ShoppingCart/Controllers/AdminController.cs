...
namespace ShoppingCart.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            BusinessLayer.Orders OrdersBL = new BusinessLayer.Orders();
            CommonLayer.OrderDetail OrderDetail = OrdersBL.GetOrderDetail(ID);
            CommonLayer.Order Order = OrdersBL.GetOrder(OrderDetail.OrderID);
            CommonLayer.User User = new BusinessLayer.Users().GetUser(Order.UserID);

            Models.Orders EditOrders = new Models.Orders();
            EditOrders.Order = Order;
            EditOrders.OrderDetail = OrderDetail;
            EditOrders.User = User;
        ...
        public ActionResult EditOrder(CommonLayer.Order Order, CommonLayer.OrderDetail OrderDetail)
        {
            ...
            new BusinessLayer.Orders().UpdateOrder(Order, OrderDetail);
